...
class CIFAR10(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        if self.train:
            img, target, target_gt = self.train_data[index], self.train_noisy_labels[index], self.train_labels[index]
        else:
            img, target, target_gt = self.test_data[index], self.test_labels[index], self.test_labels[index]
