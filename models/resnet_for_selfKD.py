...
class Multi_ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return x1, x2, middle_output1, middle_output2, middle_output3, final_fea, middle1_fea, middle2_fea, middle3_fea

def multi_resnet50_kd(num_classes=10):
    return Multi_ResNet(BottleneckBlock, [3,4,6,3], num_classes=num_classes)

def multi_resnet18_kd(num_classes=10):
    return Multi_ResNet(BasicBlock, [2,2,2,2], num_classes=num_classes)

def multi_resnet34_kd(num_classes=10):
